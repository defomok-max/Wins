...
function anthropicToOpenAI(body) {
  ...
  return {
    ...
    ...(body.agent != null ? { agent: body.agent } : {}),
    ...(body.agent_mode != null ? { agent_mode: body.agent_mode } : {}),
    ...(body.tool_execution != null ? { tool_execution: body.tool_execution } : {}),
    ...(body.working_directory != null ? { working_directory: body.working_directory } : {}),
    ...(body.agent_max_iterations != null ? { agent_max_iterations: body.agent_max_iterations } : {}),
